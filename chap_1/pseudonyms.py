"""Pseudonyms - Random Sidekick Name Generator
Generates funny names buy randomly combining names from two separate lists.
"""
...
def main():
    """Choose names at random from two tuples of names and print to screen"""
    ...
    while True:
        ...
        print("\n")
        print(Fore.RED, first_name, last_name, Style.RESET_ALL)
        print("\n")
